...
urlpatterns = [
    ...
    path('survey-response/', usr.SurveyResponseAction, name='survey_response_action'),
    path('user-emotions-detect/', usr.UserEmotionsDetect, name='user_emotions_detect'),
    path('combined-results/', usr.CombinedResultsView, name='CombinedResults'),
